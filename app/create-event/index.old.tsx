...
export default function CreateEventScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (!startHour.trim() || !startMinute.trim()) {
      Alert.alert('Error', 'Please enter the event start time (hour and minute)');
      return;
    }

    if (!endHour.trim() || !endMinute.trim()) {
      Alert.alert('Error', 'Please enter the event end time (hour and minute)');
      return;
    }
    ...
    try {
      ...
      const { data: newEvent, error: eventError } = await supabase
        ...
        .insert({
          ...
          currency: currency,
          capacity: capacity.trim() ? parseInt(capacity.trim()) : null,
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity 
          style={[
            styles.submitButton, 
            (!title.trim() || !organizer.trim() || !location.trim() || !date.trim() || !startHour.trim() || !startMinute.trim() || !endHour.trim() || !endMinute.trim() || !description.trim() || !category || isSubmitting) && styles.submitButtonDisabled
          ]}
          onPress={handleSubmit}
          disabled={!title.trim() || !organizer.trim() || !location.trim() || !date.trim() || !startHour.trim() || !startMinute.trim() || !endHour.trim() || !endMinute.trim() || !description.trim() || !category || isSubmitting}
        >
          {isSubmitting ? (
      ...
      <ScrollView style={styles.formContainer}>
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.labelHint}>Select start time and timezone</Text>
          ...
          {startHour && startMinute && (
            <Text style={styles.timePreview}>
              Start Time: {startHour}:{startMinute.padStart(2, '0')} {startPeriod} {timezone}
            </Text>
          )}
        </View>
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.labelHint}>Select when the event ends</Text>
          <View style={styles.timePickerContainer}>
            <View style={styles.timePickerField}>
              <Text style={styles.timePickerLabel}>Hour</Text>
              <TextInput
          ...
          {endHour && endMinute && (
            <Text style={styles.timePreview}>
              End Time: {endHour}:{endMinute.padStart(2, '0')} {endPeriod} {timezone}
            </Text>
          )}
          {startHour && startMinute && endHour && endMinute && (
            <Text style={[styles.timePreview, { marginTop: 8, fontFamily: 'Inter-SemiBold', color: '#10B981' }]}>
              Full Schedule: {startHour}:{startMinute.padStart(2, '0')} {startPeriod} - {endHour}:{endMinute.padStart(2, '0')} {endPeriod} {timezone}
            </Text>
          )}
        </View>
        ...
        {(!title.trim() || !organizer.trim() || !location.trim() || !date.trim() || !startHour.trim() || !startMinute.trim() || !endHour.trim() || !endMinute.trim() || !description.trim() || !category) && (
          <View style={[styles.infoContainer, { backgroundColor: '#FEF3C7', borderColor: '#F59E0B' }]}>
            <Info size={20} color="#F59E0B" />
            <Text style={[styles.infoTextFlex, { color: '#92400E' }]}>
              Please fill in all required fields: {
                [
                  ...
                  !date.trim() && 'Date',
                  !startHour.trim() && 'Start Hour',
                  !startMinute.trim() && 'Start Minute',
                  !endHour.trim() && 'End Hour',
                  !endMinute.trim() && 'End Minute',
        ...
        <TouchableOpacity 
          style={[
            ...
            (!title.trim() || !organizer.trim() || !location.trim() || !date.trim() || !startHour.trim() || !startMinute.trim() || !endHour.trim() || !endMinute.trim() || !description.trim() || !category || isSubmitting) && styles.submitEventButtonDisabled
          ]}
          onPress={handleSubmit}
          disabled={!title.trim() || !organizer.trim() || !location.trim() || !date.trim() || !startHour.trim() || !startMinute.trim() || !endHour.trim() || !endMinute.trim() || !description.trim() || !category || isSubmitting}
        >
