...
import { ArrowLeft, Calendar, Clock, MapPin, Search, TrendingUp, Users } from 'lucide-react-native';
      ...
      >
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            ...
            <Text style={styles.subtitle}>{filteredEvents.length} events scheduled</Text>
          </View>
        ...
        {filteredEvents.length === 0 ? (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>
              {searchQuery ? 'Try a different search term' : 'No events scheduled for the future'}
            </Text>
          </View>
        ) : (
              ...
              <View style={styles.eventHeader}>
                ...
                <View style={styles.headerRight}>
                  ...
                  <View style={styles.countdownBadge}>
                    <Text style={styles.countdownText}>{getDaysUntil(event.date)}</Text>
                  </View>
                </View>
              </View>
