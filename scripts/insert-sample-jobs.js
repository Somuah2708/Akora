...
const sampleJobs = [
  // Featured Jobs
  { title: 'Software Engineer', company: 'TechCorp Ghana', location: 'Accra, Ghana', job_type: 'Full Time', salary: 'GH₵3,000 - GH₵5,000/month', description: 'Join our team as a Software Engineer working on cutting-edge mobile applications.', requirements: '3+ years experience, React Native, Node.js', image_url: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: true, is_approved: true },
  
  { title: 'Marketing Intern', company: 'Global Media Ltd', location: 'Kumasi, Ghana', job_type: 'Internships', salary: 'GH₵500/month', description: 'Great opportunity for final year marketing students to gain real-world experience.', requirements: 'Final year student, Marketing major, Creative mindset', image_url: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: true, is_approved: true },
  
  { title: 'Remote Frontend Developer', company: 'Digital Solutions', location: 'Remote', job_type: 'Remote Work', salary: 'GH₵2,500 - GH₵4,000/month', description: 'Work remotely as a frontend developer building modern web applications.', requirements: 'React, TypeScript, 2+ years experience', image_url: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: true, is_approved: true },
  ...
  { title: 'Part-Time Content Writer', company: 'Creative Studios', location: 'Accra, Ghana', job_type: 'Part Time', salary: 'GH₵600/month', description: 'Create engaging content for our digital platforms on a flexible schedule.', requirements: 'Good writing skills, Flexible hours, Portfolio required', image_url: 'https://images.unsplash.com/photo-1455390582262-044cdead277a?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: true, is_approved: true },
  ...
  { title: 'Senior Accountant', company: 'Finance Group Ltd', location: 'Accra, Ghana', job_type: 'Full Time', salary: 'GH₵4,000 - GH₵6,000/month', description: 'Senior accounting position with growth opportunities.', requirements: 'CPA/ACCA, 5+ years experience, ERP knowledge', image_url: 'https://images.unsplash.com/photo-1554224311-beee2f770c4f?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: true, is_approved: true },
  
  { title: 'Engineering Intern', company: 'Tech Manufacturing Co', location: 'Tema, Ghana', job_type: 'Internships', salary: 'GH₵400/month', description: '6-month internship program for engineering students.', requirements: 'Engineering student, 3rd/4th year, Available 6 months', image_url: 'https://images.unsplash.com/photo-1581092795360-fd1ca04f0952?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: true, is_approved: true },
  ...
  { title: 'Data Analyst', company: 'FinTech Solutions', location: 'Tema, Ghana', job_type: 'Full Time', salary: 'GH₵2,000 - GH₵3,500/month', description: 'Analyze financial data and create insights for business decisions.', requirements: 'SQL, Python, Data visualization tools', image_url: 'https://images.unsplash.com/photo-1551836022-4c4c79ecde51?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: false, is_approved: true },
  
  { title: 'Product Design Intern', company: 'Creative Hub', location: 'Remote', job_type: 'Internships', salary: 'GH₵800/month', description: 'Learn product design from experienced designers while working remotely.', requirements: 'Design portfolio, Figma/Adobe XD, Creative thinking', image_url: 'https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: false, is_approved: true },
  
  { title: 'Business Development', company: 'Growth Partners', location: 'Accra, Ghana', job_type: 'Full Time', salary: 'GH₵1,500 - GH₵2,500/month', description: 'Drive business growth through strategic partnerships and sales.', requirements: 'Sales experience, Communication skills, Target-driven', image_url: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: false, is_approved: true },
  
  { title: 'Part-Time Graphic Designer', company: 'Media House', location: 'Accra, Ghana', job_type: 'Part Time', salary: 'GH₵800/month', description: 'Create visual content for social media and marketing campaigns.', requirements: 'Adobe Creative Suite, Portfolio, Flexible schedule', image_url: 'https://images.unsplash.com/photo-1626785774573-4b799315345d?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: false, is_approved: true },
  ...
  { title: 'Remote Customer Support', company: 'E-Commerce Platform', location: 'Remote', job_type: 'Remote Work', salary: 'GH₵1,200 - GH₵1,800/month', description: 'Provide excellent customer service for our e-commerce platform.', requirements: 'Customer service experience, Good communication, Problem-solving', image_url: 'https://images.unsplash.com/photo-1553877522-43269d4ea984?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: false, is_approved: true },
  ...
  { title: 'HR Intern', company: 'Corporate Solutions', location: 'Accra, Ghana', job_type: 'Internships', salary: 'GH₵450/month', description: 'Learn HR practices including recruitment, onboarding, and employee relations.', requirements: 'HR or Business student, Good interpersonal skills', image_url: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: false, is_approved: true },
  
  { title: 'Project Manager', company: 'Construction Ltd', location: 'Tema, Ghana', job_type: 'Full Time', salary: 'GH₵3,500 - GH₵5,500/month', description: 'Manage construction projects from inception to completion.', requirements: 'PMP/PRINCE2, 5+ years construction, Leadership skills', image_url: 'https://images.unsplash.com/photo-1507537297725-24a1c029d3ca?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: false, is_approved: true },
  
  { title: 'Remote Digital Marketer', company: 'Marketing Agency', location: 'Remote', job_type: 'Remote Work', salary: 'GH₵1,800 - GH₵2,500/month', description: 'Plan and execute digital marketing campaigns for various clients.', requirements: 'SEO/SEM, Social media marketing, Analytics tools', image_url: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&auto=format&fit=crop&q=60', application_link: '', is_featured: false, is_approved: true }
];
